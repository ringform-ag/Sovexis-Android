@file:Suppress("all", "FunctionName")
 ...
 * 使用 NoiseDH.kt 中的 object NoiseDH。
 */

// [BLOCKED] interface NoiseDH 已移除，NoiseDH.kt 中的 object NoiseDH 提供实现
...
// [BLOCKED] X25519DH 已移除，NoiseDH.kt 中的 object NoiseDH 提供完整实现
